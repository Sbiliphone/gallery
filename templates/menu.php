    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="index.php?action=image">Agiungi immagine</a>
                    <button onclick="location.href='index.php?action=image'" class="btn btn-secondary" style="background-color: dodgerblue" >Agiungi immagine</button>
                </li>
            </ul>
